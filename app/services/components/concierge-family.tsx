  ...
  return (
    <section id="concierge-medicine" className="bg-primary">
      <Wrapper className="grid place-content-center gap-[2rem] py-[4rem] text-center md:py-[7rem]">
        ...
        <p
          className=" text-md font-medium leading-[2.4rem] tracking-[0.02rem] text-white xs:text-md xs:leading-[3rem] md:leading-[3.6rem] lg:text-lg xxl:text-md xxl:leading-[4.5rem]"
