  ...
  return (
    <section className={className}>
      ...
      >
        ...
        <p
          className={`${align === "left" ? "text-left" : "text-center"} font-work_sans text-[1.4rem] font-normal leading-[2.4rem] tracking-[1.24px] text-black lg:text-lg lg:leading-[3.5rem]`}
        >
          {description}
        </p>
      </hgroup>
