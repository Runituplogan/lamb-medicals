...
const Dermaplanning: React.FC<DermaplaningProps> = ({ data }) => {
  return (
    <Wrapper id="dermaplanning" className="grid pt-10 space-y-[20px]">
      ...
      <p className=" text-md font-medium leading-[2.4rem] tracking-[0.02rem] text-black text-opacity-80 xs:text-md xs:leading-[3rem] md:leading-[3.6rem] lg:text-lg xxl:text-md xxl:leading-[4.5rem]">
