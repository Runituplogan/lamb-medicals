...
const AquaGold: React.FC<FacialServiceProps> = ({ data, aquaGoldFaq }) => {
  return (
    <Wrapper id="aqua-gold" className="grid gap-[4rem] space-y-[40px] pb-16">
      ...
      <p className="my-4  text-md font-medium leading-[2.4rem] tracking-[0.02rem] text-[black] xs:text-md xs:leading-[3rem] md:leading-[3.6rem] lg:text-lg xxl:text-md xxl:leading-[4.5rem]">
      ...
      <p className=" text-md font-medium leading-[2.4rem] tracking-[0.02rem] text-black xs:text-md xs:leading-[3rem] md:leading-[3.6rem] lg:text-lg xxl:text-md xxl:leading-[4.5rem]">
