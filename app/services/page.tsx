...
export default function Page() {
  return (
    <section className="overflow-hidden pt-5 sm:pt-16">
      <ServiceHeroSection />
      <div className="w-full font-work_sans bg-primary flex sm:flex-row flex-col justify-center items-center gap-16 md:gap-20 lg:gap-36 xl:gap-48 text-white py-20 md:py-28 lg:py-36">
